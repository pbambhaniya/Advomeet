...
import com.multipz.atmiyalawlab.Adapter.MyAppointmentAdapter;
...
public class ActivityMyAppointmentList extends AppCompatActivity implements ItemClickListener {
...
//                String param = "{\"action\":\"" + Config.getcountry + "\"}";
    ...
    private void setAdapter() {
        adapter = new MyAppointmentAdapter(tempList, context);
    ...
    public void itemClicked(View view, int position) {
        ...
        if (view.getId() == R.id.txtshowdetail) {
            Intent i = new Intent(ActivityMyAppointmentList.this, ActivityBookAppointment.class);
            ...
            i.putExtra("status_id", model.getStatus_id());
            i.putExtra("is_payment", model.getIs_payment());
            ...
            if (model.getStatus_id() == 1) {
                popCancelDailog(appointment_id, Config.cancelRequest);
            } else {
                popCancelDailog(appointment_id, Config.cancelApproveRequest);
            }
    ...
    private void CancelAppoinment(final int appointment_id, final int status) {
        String tag_string_req = "string_req";
        String url = Config.BASE_URL;
        dialog = new ProgressDialog(ActivityMyAppointmentList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.contentEquals("1")) {
                        ...
                        Toaster.getToast(getApplicationContext(), "" + msg);
                        Intent intent = new Intent(ActivityMyAppointmentList.this, ActivityMyAppointmentList.class);
    ...
    void popCancelDailog(final int appointment_id, String msg) {

        LayoutInflater inflater = ActivityMyAppointmentList.this.getLayoutInflater();
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(ActivityMyAppointmentList.this);
        builder.setView(c);
    ...
    void popRejected(final int appointment_id) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(ActivityMyAppointmentList.this);
        alertDialog.setMessage(Config.rejected);
