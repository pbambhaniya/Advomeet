...
public class LoginUserActivity extends BaseActivity implements SinchService.StartFailedListener {
    ...
    private void openPlaceCallActivity() {
        Intent mainActivity = new Intent(this, RecieoentUserActivity.class);
