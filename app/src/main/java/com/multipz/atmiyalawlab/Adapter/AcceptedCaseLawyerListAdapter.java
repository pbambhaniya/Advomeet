...
public class AcceptedCaseLawyerListAdapter extends RecyclerView.Adapter<AcceptedCaseLawyerListAdapter.MyViewHolder> {
    ...
    public AcceptedCaseLawyerListAdapter(Context context, List<LawyerListModel> list) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.txt_experiense.setText("Experience " + model.getExperienceinyear() + "." + model.getExperienceinmonth() + " Year");
